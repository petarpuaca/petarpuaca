...
const controlSearchResults = async function() {
    try {
        ...
        (0, _paginationViewDefault.default).render(_model.state.seacrh);
    } catch (err) {
        console.log(err);
    }
};
...
},{"core-js/modules/web.immediate.js":"bzsBv","./model":"3QBkH","./config":"2hPh4","./views/recipeView":"3wx5k","./views/searchView":"kbE4Z","./views/resultsView":"kBQ4r","./views/paginationView":"7NIiB","./views/bookmarksView":"1qGeA","./views/addRecipeView":"8AWnP","regenerator-runtime/runtime":"f6ot0","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"bzsBv":[function(require,module,exports,__globalThis) {
'use strict';
...
const loadSearchResults = async function(query) {
    try {
        ...
        state.seacrh.page = 1;
        console.log(state.seacrh.results);
    } catch (err) {
        console.error(err + ' $$$$$');
        throw err;
    }
};
const getSearchResultsPage = function(page = state.seacrh.page) {
    state.seacrh.page = page;
    const start = (page - 1) * state.seacrh.resultsPerPage;
    const end = page * state.seacrh.resultsPerPage;
    return state.seacrh.results.slice(start, end);
};
...
const KEY = '001a28b9-1aef-4760-8795-b2c46ebe25ec';
...
var _packageJson = require("../../../node_modules/fractional/package.json");
...
},{"url:../../img/icons.svg":"fd0vu","./View":"jSw21","../../../node_modules/fractional/package.json":"5O86v","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"fd0vu":[function(require,module,exports,__globalThis) {
...
},{"url:../../img/icons.svg":"fd0vu","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"5O86v":[function(require,module,exports,__globalThis) {
module.exports = JSON.parse("{\"name\":\"fractional\",\"version\":\"1.0.0\",\"description\":\"fraction arithmetic\",\"main\":\"index.js\",\"scripts\":{\"test\":\"echo \\\"Error: no test specified\\\" && exit 1\"},\"repository\":{\"type\":\"git\",\"url\":\"https://github.com/ekg/fraction.js.git\"},\"keywords\":[\"fraction\",\"arithmetic\",\"math\"],\"author\":\"Erik Garrison\",\"license\":\"MIT\",\"bugs\":{\"url\":\"https://github.com/ekg/fraction.js/issues\"},\"homepage\":\"https://github.com/ekg/fraction.js\"}");
